...
<script type="text/javascript">
	...
	//添加
	function save() {
		var url = "/core/userType/save_userType";
	...
	//删除
	function deleteBase() {
		var url = "/core/userType/delete_userType";
	...
	function showUpdate(typeId) {
		var url = "/core/userType/get_userType";
		var data = {
			"typeId" : typeId
		};
		ajaxSupport(url, data, function(result) {
	...
	//更新
	function update() {
		var url = "/core/userType/update_userType";
...
<div class="bc utc">
	<div class="btd">
		...
		<div class="btf uttf">
			<a
				href="/core/userType/list_userType?pageNo=${condition.page.pageNo-1}"
				class="">上一页</a> <a
				href="/core/userType/list_userType?pageNo=${condition.page.pageNo+1}"
