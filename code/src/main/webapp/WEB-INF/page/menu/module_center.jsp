...
<script type="text/javascript">
	...
	//添加
	function save() {
		var url = "/code/module/save_module";
	...
	//删除
	function deleteBase() {
		var url = "/code/module/delete_module";
	...
	function showUpdate(moduleId) {
		var url = "/code/module/get_module";
		var data = {
			"moduleId" : moduleId
		};
		ajaxSupport(url, data, function(result) {
	...
	//更新
	function update() {
		var url = "/code/module/update_module";
...
<div class="bc moc">
	<div class="btd">
		...
		<div class="btf motf">
			<a
				href="/code/module/list_module?pageNo=${conditionParam.page.pageNo-1}"
				class="">上一页</a> <a
				href="/code/module/list_module?pageNo=${conditionParam.page.pageNo+1}"
